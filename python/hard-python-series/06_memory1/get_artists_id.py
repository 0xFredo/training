...
# edit this list
to_be_searched_artits = ["Gazzelle", "Led Zeppelin", "Tupac", "Coolio", "Elio e le storie tese", "Queen", "Eminem", "Al Bano", "Mina", "Ghali", "Muse", "The Beatles", "The Rolling Stones", "Micheal Jackson", "I Prevail", "Oasis", "Pink Floyd", "Billie Eilish", "Drake", "Panetty", "Naska", "Daft Punk"]
...
with open("data/artists.json", "w", encoding = "UTF-8") as json_file:
